...
# 	audio = wave.open('sampleStego.wav','rb')
...
# # 	audio.close()
# message = "1"
# encode(r'C:\Users\ariel\Downloads\551daaf6-7d54-406e-923e-809077a01d7d.wav', message)
# # decode()
...
# 	print("Sucessfully decoded: "+decoded)
# 	audio.close()
#audio_file_path = r'C:\Users\ariel\PycharmProjects\pythonProject1\Stenography\Audio\sampleStegoM.wav'
audio_file_path = r'C:\Users\ariel\PycharmProjects\pythonProject1\Audio_c\sampleStego.wav'
