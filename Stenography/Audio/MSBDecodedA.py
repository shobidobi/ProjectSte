...
def decode():
    ...
    while l < len(frame_bytes):
        ...
        t[3] = binary_representation(three_byte[2])[1]
        t[2] = binary_representation(three_byte[2])[0]
        t[1] = binary_representation(three_byte[1])[1]
        t[0] = binary_representation(three_byte[1])[0]
